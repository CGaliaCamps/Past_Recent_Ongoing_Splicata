#! /bin/bash
path=/piec2/cgalia/Styela_mundial/2bRAD_world/7structure/atl_noinv_nomissing/
...
#			/piec1/software/Structure/console/structure -m /piec1/software/Structure/console/mainparams -e /piec1/software/Structure/console/extraparams -i $path$file -D 123 -L $loci -N $number -K 1 -o $path/$file\_1_$t.txt > $path/$file\_K1_$t &
			/piec1/software/Structure/console/structure -m /piec1/software/Structure/console/mainparams -e /piec1/software/Structure/console/extraparams -i $path$file -D 123 -L $loci -N $number -K 2 -o $path/$file\_2_$t.txt > $path/$file\_K2_$t &
